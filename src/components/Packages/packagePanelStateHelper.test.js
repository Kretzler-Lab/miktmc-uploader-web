...
describe('getMessage', () => {
	...
	it('should return the correct message for UPLOAD_FAILED when is not large file and is mine', () => {
		...
		let expectedMessage = <div><div>The file(s) in this package could not be processed. It is recommended that you re-upload this package.</div><br/><div>For more information please contact MiKTMC Uploader support at <a target='_blank' rel='noopener noreferrer' href='mailto:miktmc-help@umich.edu'>miktmc-help@umich.edu</a></div></div>;
